...
const SAMPLE_CARE_PLAN = {
  ...
  en: {
    ...
    medications: [
      ...
      { name: "Salbutamol", dose: "2 puffs (90 mcg/puff)", frequency: "Every 4–6 hours as needed", instructions: "Shake the inhaler well before each use. Breathe out fully. Inhale 2 puffs slowly and hold your breath for 10 seconds each time. Wait 1 minute between each puff. Rinse your mouth after using the inhaler. Go to the emergency room if you use more than 8 puffs in 24 hours and still feel bad, or if your symptoms do not get better in 20 minutes." },
      { name: "Cetirizine", dose: "10 mg", frequency: "Once daily", instructions: "Take 1 tablet every day at the same time. You can take it with or without food. This medicine can make you sleepy. Do not drive or use machines if you feel sleepy. Do not drink alcohol while on this medicine because it will make you drowsier." },
    ],
    appointments: [
      { purpose: "Pneumonia follow-up with General Doctor (GP)", date: "On or before February 28, 2026", time: "To be confirmed", location: "To be confirmed" },
      { purpose: "Breathing and asthma check at Lung Clinic", date: "To be confirmed by March 7, 2026", time: "To be scheduled", location: "Outpatient Respiratory Clinic" },
    ],
  },
  es: {
    ...
    medications: [
      ...
      { name: "Prednisona", dose: "40 mg", frequency: "Una vez al día (mañana, con comida)", instructions: "Tome 1 tableta por la mañana con comida o leche. Tómela exactamente por 3 días y termine todas las dosis. No la tome con el estómago vacío. Manténgase alejado de personas con varicela o herpes zóster. Dígale a su doctor antes de recibir vacunas. Esta medicina puede aumentar el hambre, causar irritabilidad, dificultad para dormir, enrojecimiento facial o aumento del azúcar en la sangre." },
      { name: "Salbutamol", dose: "2 inhalaciones (90 mcg/inhalación)", frequency: "Cada 4–6 horas según sea necesario", instructions: "Agite bien el inhalador antes de cada uso. Exhale completamente. Inhale 2 veces lentamente y sostenga la respiración por 10 segundos cada vez. Espere 1 minuto entre cada inhalación. Enjuague su boca después de usar el inhalador. Vaya a la sala de emergencias si usa más de 8 inhalaciones en 24 horas y aún se siente mal, o si sus síntomas no mejoran en 20 minutos." },
      { name: "Cetirizina", dose: "10 mg", frequency: "Una vez al día", instructions: "Tome 1 tableta todos los días a la misma hora. Puede tomarla con o sin comida. Esta medicina puede causar sueño. No conduzca ni use máquinas si tiene sueño. No beba alcohol mientras toma esta medicina porque le dará más sueño." },
    ],
    appointments: [
      { purpose: "Seguimiento de neumonía con Médico General", date: "En o antes del 28 de febrero de 2026", time: "Por confirmar", location: "Por confirmar" },
      { purpose: "Revisión de respiración y asma en la Clínica Pulmonar", date: "Por confirmar antes del 7 de marzo de 2026", time: "Por agendar", location: "Clínica Respiratoria Ambulatoria" },
    ],
  },
};
